...
blues10 = ["#1f77b4", "#ff7f0e", "#2ca02c", "#d62728", "#9467bd", "#8c564b", "#e377c2", "#7f7f7f", "#bcbd22", "#17becf"]


divergent_blue_red13 = np.array([
    "#395e8f#5a749f#798caf#97a4bf#b4bdcf#d2d6e0#f1f1f1#f3d9d1#f3c1b2#f1a994#ec9077#e6785a#de5e3e"
])


divergent_br248842_13 = np.array([
    "#224488",
    "#4c5e99",
    "#6e79ab",
    "#8f95bc",
...
pallet_tum = {
    "blue_3": "#0065BD",  # Blue ordered from light to dark
    "blue_4": "#005293",
    "blue_5": "#003359",
    "blue_2": "#64A0C8",
    "blue_1": "#98C6EA",
...
tum_mix5 = [pallet_tum["blue_3"], pallet_tum["orange"], pallet_tum["beige"], pallet_tum["green"], pallet_tum["grey_50"]]
...
def c_list_wrapper(c, n=20):
    c_list_dict = {
        "tum_blue443": [pallet_tum["blue_4"], pallet_tum["blue_4"], pallet_tum["blue_3"]],
        "tum_blue4432": [pallet_tum["blue_4"], pallet_tum["blue_4"], pallet_tum["blue_3"], pallet_tum["blue_2"]],
...
def rgb2hex(rgb):
    h = int(rgb[0] * 255) * 256**2 + int(rgb[1] * 255) * 256**1 + int(rgb[2] * 255) * 256**0
    return h
